...
1. NFTの「よく言われる定義」とその誤解
2. NFTの現在地 - ハイプサイクルと市場動向
3. NFTの歴史 - バブルから学ぶ教訓
4. 実際のユースケース - ゲームとDeFi
5. NFTの技術的な真実
6. 批判への反論
7. 未来への展望
...
- キャラ交配でNFT増殖、独自トークンがバブルを生み、以降デファクトに
...
### パターン1
同じチェーンで違うコントラクトアドレス、全く同じMetadata

### パターン2
違うチェーンで同じコントラクトアドレス、全く同じMetadata

### 見分け方
**「チェーン+コントラクトアドレス+トークンID」を確認**

これだけで偽物は判別可能
しかし比較でしか判別できないため、正しい情報が何かを知っている必要がある
